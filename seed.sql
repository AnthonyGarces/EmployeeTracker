...
INSERT INTO `employee_trackerdb`.`role` (`ID`, `title`, `salary`, `department ID`) VALUES ('1', 'Sales Rep', '60000', '3');
INSERT INTO `employee_trackerdb`.`role` (`ID`, `title`, `salary`, `department ID`) VALUES ('2', 'Accountant', '75000', '1');
INSERT INTO `employee_trackerdb`.`role` (`ID`, `title`, `salary`, `department ID`) VALUES ('3', 'CEO', '250000', '4');
INSERT INTO `employee_trackerdb`.`role` (`ID`, `title`, `salary`, `department ID`) VALUES ('4', 'HR Rep', '65000', '2');
